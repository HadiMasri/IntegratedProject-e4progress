...
{
  public  class UpdateCourseDialogViewModel : BindableBase
    {
        ...
        private string _imageName = SR.ResourceManager.GetString("ImageName", Thread.CurrentThread.CurrentUICulture);
